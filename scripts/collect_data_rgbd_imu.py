...
# Initialize RealSense camera pipeline for RGB, Depth, and IMU
...
try:
    while True:
        ...
        cv2.imshow('RealSense Stream - RGB, Depth, and IMU', stacked_image)
        ...
        if is_recording:
            ...
            # Log joystick and IMU values with image names
            with open(label_path, 'a+', newline='') as f:
                writer = csv.writer(f)
                writer.writerow([
                    f"{frame_counts}_rgb.png",
                    f"{frame_counts}_depth.png",
